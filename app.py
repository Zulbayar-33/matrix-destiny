...
PLAN_MAP = {
    "7 хоног - 3000₮": {"price": 3000, "days": 7},
    "1 сар - 10000₮": {"price": 10000, "days": 30},
    "6 сар - 30000₮": {"price": 30000, "days": 180},
    "1 жил - 50000₮": {"price": 50000, "days": 365},
}
...
def extract_response_text(response):
    """
    Safer parser. First try SDK convenience field, then fallback.
    """
...
if QR_PATH.exists():
    st.image(str(QR_PATH), caption=f"{selected_price}₮ төлнө үү", use_container_width=True)
else:
